...
public static class DateTimeExtensions
{
    ...
    extension(DateTime date)
    {
        ...
        public DateTime AddWeeks(int numberOfWeeks) => date.AddDays(numberOfWeeks * 7);
        ...
        public int Age(DateTime calculateFrom = default)
        {
        ...
        public DateTime BeginningOf(TimeFrame timeFrame, CultureInfo? culture = null)
        {
        ...
        // Returns:
        //     The beginning of a specific time frame
        public DateTime BeginningOf(TimeFrame timeFrame, DateTime startOfQuarter1, CultureInfo? culture = null)
        {
        ...
        public int DaysIn(TimeFrame timeFrame, CultureInfo? culture = null)
        {
            culture ??= CultureInfo.CurrentCulture;
        ...
        // Returns:
        //     The number of days in the time frame
        public int DaysIn(TimeFrame timeFrame, DateTime startOfQuarter1, CultureInfo? culture = null)
        {
            if (timeFrame != TimeFrame.Quarter)
            {
        ...
        public DateTime BeginningOfQuarter()
        {
        ...
        public DateTime EndOf(TimeFrame timeFrame, CultureInfo? culture = null)
        {
            culture ??= CultureInfo.CurrentCulture;
