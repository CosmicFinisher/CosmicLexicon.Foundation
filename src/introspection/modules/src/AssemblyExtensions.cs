...
namespace CosmicLexicon.Foundation.Introspection.Modules
{
    ...
    public static class AssemblyExtensions
    {
        ...
        {
            public IEnumerable<Type> QueryTypes(AssemblyTypeCollectionQuery loadingCondition) => loadingCondition switch
            {
                AssemblyTypeCollectionQuery.All => assembly.DefinedTypes,
                AssemblyTypeCollectionQuery.Exported => assembly.ExportedTypes,
                _ => throw new NotImplementedException(),
            };
            public IEnumerable<Type> GetTypes(AssemblyTypeQuery loadingCondition) => loadingCondition switch
            {
            ...
            public IEnumerable<Type> FilterTypes(Type type,
            ...
            public IEnumerable<Type> FilterTypesByInterface<TInterface>(
                                                    AssemblyTypeQuery loadingCondition = AssemblyTypeQuery.All,
                                               InterfaceFilter interfaceFilter = InterfaceFilter.None,
                                                 bool? genericEqual = null) => assembly.FilterTypesByInterface(typeof(TInterface), loadingCondition, interfaceFilter, genericEqual ?? typeof(TInterface).ShouldGenericEquals());
            public IEnumerable<Type> FilterTypesByInterface(Type type,
                                                           AssemblyTypeQuery loadingCondition = AssemblyTypeQuery.All,
                                                      InterfaceFilter interfaceFilter = InterfaceFilter.None,
            ...
            public IEnumerable<Type> FilterTypesByBaseType(Type type,
                                                           AssemblyTypeQuery loadingCondition,
            ...
            public IEnumerable<Type> FilterTypesByBaseClass(Type baseClass,
                                                           AssemblyTypeQuery loadingCondition,
                                                           AssemblyTypeFilter[] filters,
        ...
        extension(Type type)
        {
            public bool CompareTypeDefenition(Type other) => other.GenericTypeArguments.Length < 1
                        ?
                                        type.GetTypeDefenitionIfItIsGeneric() == other.GetTypeDefenitionIfItIsGeneric()
                                    :
                                          type == other;

            public Type GetTypeDefenitionIfItIsGeneric()
            {
        ...
        private static bool LookupInBaseClasses(Type baseClass, Type type, bool genericEqual) => type.GetBaseClasses()
