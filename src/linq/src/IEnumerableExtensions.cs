...
namespace CosmicLexicon.Foundation.Structures.Linq
{
    ...
    public static class IEnumerableExtensions
    {
        ...
        {
            public bool Empty() => array.ToNullSafeArray().Length == 0;
            public T?[] ToNullSafeArray() => array?.ToArray() ?? [];
            public IEnumerable<T?> ToNullSafeEnumerable() => array?.ToArray() ?? [];
        }

        extension<T>(IEnumerable<T>? enumerable)
        {
            public bool IsNullOrEmpty() => enumerable == null || !enumerable.Any();
        }
        ...
        extension<T>(IEnumerable<T> list)
        {
            ...
            public IEnumerable<T> ElementsBetween(int start, int end)
            {
            ...
            // Returns:
            //     The original list
            public IEnumerable<T> For(int start, int end, Action<T, int> action)
            {
                if (list == null || !list.Any())
                {
                    return [];
            ...
            // Returns:
            //     The original list
            public IEnumerable<T> ForEach(Action<T> action, Action<T, Exception> catchAction)
            {
                if (list == null || !list.Any())
                {
                    return [];
            ...
            // Returns:
            //     The original list
            public IEnumerable<T> ForEachParallel(Action<T> action)
            {
                if (list == null || !list.Any())
                {
                    return [];
            ...
            // Returns:
            //     The original list
            public IEnumerable<T> ForParallel(int start, int end, Action<T, int> action)
            {
                if (list == null || !list.Any())
                {
                    return [];
            ...
            // Returns:
            //     the original Item
            public IEnumerable<T> ThrowIfAll(Func<T, bool> predicate, Func<Exception> exception)
            {
                if (list == null)
                {
                    return list;
            ...
            // Returns:
            //     the original Item
            public IEnumerable<T> ThrowIfAll(Func<T, bool> predicate, Exception exception)
            {
                if (list == null)
                {
                    return list;
            ...
            // Returns:
            //     the original Item
            public IEnumerable<T> ThrowIfAny(Func<T, bool> predicate, Func<Exception> exception)
            {
                if (list == null)
                {
                    return list;
            ...
            // Returns:
            //     the original Item
            public IEnumerable<T> ThrowIfAny(Func<T, bool> predicate, Exception exception)
            {
                if (list == null)
                {
                    return list;
            ...
            // Returns:
            //     A string
            public string ToString(Func<T, string>? itemOutput = null, string seperator = ",")
            {
                if (list == null)
                {
                    return "";
        ...
        extension<T>(IEnumerable<T> value)
        {
            ...
            public IEnumerable<T> Except(Func<T, bool> predicate)
            {
        ...
        extension<TObject>(IEnumerable<TObject> list)
        {
            //
            // Summary:
            ...
            // Returns:
            //     The resulting list
            public IEnumerable<TResult> For<TResult>(int start, int end, Func<TObject, int, TResult> function)
            {
            ...
            // Returns:
            //     The resulting list
            public IEnumerable<TResult> ForEach<TResult>(Func<TObject, TResult> function)
            {
                ...
                return [.. list.Select((x) => function2(x))];
            }
            ...
            // Returns:
            //     The resulting list
            public IEnumerable<TResult> ForEach<TResult>(Func<TObject, TResult> function, Action<TObject, Exception> catchAction)
            {
                Func<TObject, TResult> function2 = function;
            ...
            public IEnumerable<TResult> ForEachParallel<TResult>(Func<TObject, TResult> function)
            {
                Func<TObject, TResult> function2 = function;
                if (list == null || function2 == null || !list.Any())
                {
            ...
            // Returns:
            //     The results in an IEnumerable list
            public IEnumerable<TObject> ForEachParallel(Action<TObject> action, Action<TObject, Exception> catchAction)
            {
            ...
            // Returns:
            //     The resulting list
            public IEnumerable<TResult> ForEachParallel<TResult>(Func<TObject, TResult> function, Action<TObject, Exception> catchAction)
            {
            ...
            // Returns:
            //     The results in an IEnumerable list
            public IEnumerable<TResult> ForParallel<TResult>(int start, int end, Func<TObject, int, TResult> function)
            {
                if (list == null || function == null || !list.Any())
                {
                    return [];
        ...
        extension<TSource>(IEnumerable<TSource> list)
        {
            ...
            public TTarget[] ToArray<TTarget>(Func<TSource, TTarget> convertingFunction)
            {
                if (list == null)
                {
                    return [];
            ...
            public List<TTarget> ToList<TTarget>(Func<TSource, TTarget> convertingFunction)
            {
                if (list == null)
                {
                    return [];
        ...
        extension<T>(IEnumerable<T> collection)
        {
            ...
            public IEnumerable<T> Transverse(Func<T, IEnumerable<T>> property)
            {
                if (collection == null)
                {
                    yield break;
