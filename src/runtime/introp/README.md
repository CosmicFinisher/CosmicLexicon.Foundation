...
*   **Rules & Policies:**
    *   Aligns with `System.Runtime.InteropServices`.
    *   Use with caution due to the complexities and potential instability of interop.
    *   Encapsulate common P/Invoke signatures or marshalling helpers if widely needed. 