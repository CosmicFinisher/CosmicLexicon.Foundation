...
|-----------------------------|-----------|-------------|
| OpenEchoSystem.Core.xText                   | 0.0975    | 0.0753      |
| OpenEchoSystem.Core.xRuntime                | 1.00      | 0.9285      |
| OpenEchoSystem.Core.xCollections            | 0.3333    | 0.2302      |
| OpenEchoSystem.Core.xText.Json              | 0.5714    | 0.75        |
| OpenEchoSystem.Core.xExceptions             | 1         | 1           |
| OpenEchoSystem.Core.xSecurity               | 1         | 1           |
| OpenEchoSystem.Core.xNet                    | 0.4545    | 1           |
| OpenEchoSystem.Core.xReflection.Assembly    | 0.4802    | 0.2825      |
| OpenEchoSystem.Core.xRuntime.Serialization  | 1         | 1           |
| OpenEchoSystem.Core.xGenerics               | 0.3557    | 0.2264      |
| OpenEchoSystem.Core.xExtensions             | 0.9375    | 0.875       |
| OpenEchoSystem.Core.xThreading.Tasks        | 1         | 1           |
| OpenEchoSystem.Core.xRuntime.InteropServices| 1         | 1           |
| OpenEchoSystem.Core.xThreading.Timers       | 1         | 1           |
| OpenEchoSystem.Core.xText.RegularExpressions| 1         | 1           |
| OpenEchoSystem.Core.xThreading              | 1         | 1           |
| OpenEchoSystem.Core.xIO                     | 1         | 0.9285      |

**Quantitative Assessment:**
- Overall line coverage: 29.85%
- Overall branch coverage: 18.93%
- Number of modules with 100% line coverage: 9 (OpenEchoSystem.Core.Exceptions, OpenEchoSystem.Core.Security, OpenEchoSystem.Core.Runtime.Serialization, OpenEchoSystem.Core.Threading.Tasks, OpenEchoSystem.Core.Runtime.InteropServices, OpenEchoSystem.Core.Threading.Timers, OpenEchoSystem.Core.Text.RegularExpressions, OpenEchoSystem.Core.Threading, OpenEchoSystem.Core.IO, OpenEchoSystem.Core.Runtime)
- Number of modules with less than 50% line coverage (identified as coverage gaps): 4 (OpenEchoSystem.Core.Text, OpenEchoSystem.Core.Collections, OpenEchoSystem.Core.xReflection.Assembly, OpenEchoSystem.Core.Generics)
